...
window = tk.Tk()
window.title("Sci Spy Hybrid Camera")
...
label_title = tk.Label(frame1, text="SCI-SPY HYBRID CAMERA",bg='skyblue')
...
label_icon = tk.Label(frame1, image=icon,bg='skyblue')
...
btn1 = tk.Button(frame1, text='Monitor', height=90, width=180, fg='Royalblue3',bg="white",command = find_motion, image=btn1_image, compound='left')
btn1['font'] = btn_font
btn1.grid(row=3, pady=(20,10))

btn2 = tk.Button(frame1, text='Rectangle', height=90, width=180, fg='Royalblue3',bg="white", command=rect_noise, compound='left', image=btn2_image)
btn2['font'] = btn_font
btn2.grid(row=3, pady=(20,10), column=3, padx=(20,5))

btn_font = font.Font(size=25)
btn3 = tk.Button(frame1, text='Motion', height=90, width=180, fg='Royalblue3',bg="white", command=noise, image=btn3_image, compound='left')
btn3['font'] = btn_font
btn3.grid(row=5, pady=(20,10))

btn4 = tk.Button(frame1, text='Record', height=90, width=180, fg='Royalblue3',bg="white", command=record, image=btn4_image, compound='left')
btn4['font'] = btn_font
btn4.grid(row=5, pady=(20,10), column=3)


btn6 = tk.Button(frame1, text='In Out', height=90, width=180, fg='Royalblue3', bg="white",command=in_out, image=btn6_image, compound='left')
btn6['font'] = btn_font
btn6.grid(row=5, pady=(20,10), column=2)

btn5 = tk.Button(frame1, height=90, width=180, fg='Royalblue3',bg="white", command=window.quit, image=btn5_image)
btn5['font'] = btn_font
btn5.grid(row=6, pady=(20,10), column=2)

btn7 = tk.Button(frame1, text="identify",fg='Royalblue3',command=maincall,bg="white", compound='left', image=btn7_image, height=90, width=180)
btn7['font'] = btn_font
